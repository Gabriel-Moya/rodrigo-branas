  ...
  <div>
    ...
    <div id="main">
      <div class="container">
        <div class="row">
          <div class="col-md">
            <h5>Prefixos <span class="badge bg-info">{{ prefixes.length }}</span></h5>
            <div class="card">
              <div class="card-body">
                <ul class="list-group">
          ...
          <div class="col-md">
            <h5>Sufixos <span class="badge bg-info">{{ sufixes.length }}</span></h5>
            <div class="card">
              <div class="card-body">
                <ul class="list-group">
		...
		domains() {
			...
			for (const prefix of this.prefixes) {
				for (const sufix of this.sufixes) {
					...
					const checkout = `https://cart.hostgator.com.br/?a=add&sld=${url}&tld=.com.br`;
					domains.push({
						name,
						checkout
					});
